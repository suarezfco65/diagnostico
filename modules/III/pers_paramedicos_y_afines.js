...
const pers_paramedicos_y_afines = {
      ...
      label: "Personal del centro médico (Paramédicos y Afines)",
      fields: [
        { key: "datosInstitucion.nombre", label: "Institución" },
        { key: "datosInstitucion.parroquia", label: "Parroquia" },
        {
          key: (data) => totalPersonal(data, `paramedicos-y-afines`, ``, `disponible`),
          label: "Centro (D)",
        },
        {
          key: (data) => totalPersonal(data, `paramedicos-y-afines`, ``, `requerido`),
          label: "Centro (R)",
        },
        {
          key: (data) => ((totalPersonal(data, `paramedicos-y-afines`, ``, `requerido`) - totalPersonal(data, `paramedicos-y-afines`, ``, `disponible`)) * 100 / totalPersonal(data, `paramedicos-y-afines`, ``, `requerido`)).toFixed(2) + '%',
          label: "Deficit (%)",
        },
      ],
