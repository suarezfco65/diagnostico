...
const pers_obrero = {
    id: "pers_obrero",
    label: "Personal del centro médico (Obrero)",
    fields: [
        ...
        {
            key: (data) => ((totalPersonal(data, `obrero`, ``, `requerido`) - totalPersonal(data, `obrero`, ``, `disponible`)) * 100 / totalPersonal(data, `obrero`, ``, `requerido`)).toFixed(2) + '%',
            label: "Deficit (%)",
        },
    ],
