...
import infr_oper_areas from "./VI/infr_oper_areas.js";
...
const REPORT_DEFINITIONS_BY_SECTION = {
  ...
  II: [
    ...
    aut_subDirector,
    aut_enlace,
    aut_jefeServiciosMedicos,
    aut_jefeMantenimiento,
  ],
  III: [
    pers_todos,
    pers_servicios_medicos,
    pers_paramedicos_y_afines,
    pers_administrativo,
    pers_obrero,
  ],
  ...
  V: [
    oserv_imag_activos,
    oserv_imag_activosProblemas,
    oserv_imag_inactivos,
    oserv_imag_inexistentes,
    oserv_farm_basicos,
    oserv_farm_especializados,
    oserv_farm_altoCosto,
    oserv_lab_disponibilidad_1,
    oserv_lab_disponibilidad_2,
    oserv_lab_disponibilidad_3,
    oserv_coc_activos,
    oserv_coc_activosProblemas,
    oserv_coc_inactivos,
    oserv_coc_inexistentes,
  ],
  VI: [
    infr_oper_areas,
    infr_cond_cocina,
    infr_cond_consultorios,
    infr_cond_farmacia,
    infr_cond_hospitalizacion,
    infr_cond_laboratorio,
    infr_cond_quirofanos,
    infr_servPub_1,
    infr_servPub_2,
  ],
  VII: [proy_actuales],
